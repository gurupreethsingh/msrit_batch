// console.log("gurupreeth");
// document.write("<p>THis is the paragraph.</p>");

// lireals 
// 1. numbers  - integers, decimal (no single or double)
// 2. characters - single quotes. 
// 3. strings  - double quotes.
// 4. booleans - true, false (without any quotes.)

// console.log(10);  // 4bytes
// console.log(2.4);  // 4 bytes
// console.log(typeof(10));
// console.log(typeof(2.4));
// console.log('a');
// console.log('8');   // 2 

// console.log("Kentappa");   // undefined. 
